                        ...
                        <?php foreach ($pembayaran_psb as $m) { }?>
                       	<table class="table table-striped table-bordered table-hover" style="width: 100%">
  	                        <tr>
  	                        	...
  	                        	<td>:</td>
  	                         	<td colspan="2"><?php echo $m->nama_lengkap; ?></td>
  	                        </tr>
  	                        <tr>
  	                        	<td>Nomor Pendaftaran</td>
  	                        	<td>:</td>
  	                         	<td colspan="2"><?php echo $m->nomor_daftar; ?></td>
  	                        </tr>  
  	                        <tr>
  	                        	<td>Guna Membayar</td>
  	                        	<td>:</td>
  	                    ...
  	                    <table border="0" width="100%">
  	                    	<tr>
  	                    		...
  	                    		<td align="right">Semarang, ..........................................<br><br></td>
  	                    	</tr>
  	                    	<tr>
                            <td align="center" colspan="2">Orang Tua Siswa / Wali Siswa<br><br><br><br></td>
  	                    		<td align="center" colspan="2">Bendahara PPDB<br><br><br><br></td>
  	                    	</tr>
  	                    	<tr>
