<div class="box">
  <div class="box-header">
    <div class="col-md-6" style="padding: 0;">
      ...
      <div class="row">
        <div class="col-lg-6">
          <form role="form" action="<?php echo base_url(); ?>Laporan_spp/filter" method="post" enctype="multipart/form-data" name="form" class="form" id="form" onsubmit="return validate(this)" onClick="highlight(event)" onKeyUp="highlight(event)">
  ...
  <div class="box-body">
    ...
    <div>
      <table class="table">
        ...
        <tr>
          <td>
            <a href="<?php echo base_url(); ?>Laporan_spp/cetak/<?php echo $k3->id_kelas_siswa; ?>/<?php echo $k1->id_setting_pembayaran; ?>" target="_BLANK">
