          ...
          ?>
            <tr>
              ...
              <td>
                ...
                ?>
                <a href="<?= base_url() . 'riwayat_pembayaran/view_pembayaran/' . $nis . '/' . $k->id_setting_pembayaran . '/' . $k->id_tahun_ajaran . '/' . $k->id_unit_pendidikan . '/' . $k->id_tipe_pembayaran ?>">
                  <button class="btn btn-basic">View <?php //var_dump($row) 
                                                      ?></button>
                </a>
              </td>
