    ...
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <select class="form-control select2" name="id_tahun_ajaran" id="id_tahun_ajaran" data-placeholder="Select Tahun Ajaran">
          ...
          <option value="<?php echo $j->id_tahun_ajaran; ?>" <?php if($j->id_tahun_ajaran == $k->id_tahun_ajaran){echo "selected='selected'";} ?>><?php echo $j->tahun_ajaran; ?></option>
          <?php } ?>
        </select>
      </div>
      <div class="form-group">
        ...
        <select class="form-control select2" name="id_tipe_pembayaran" id="id_tipe_pembayaran" data-placeholder="Select Tipe Pembayaran">
          ...
          <option value="<?php echo $j->id_tipe_pembayaran; ?>" <?php if($j->id_tipe_pembayaran == $k->id_tipe_pembayaran){echo "selected='selected'";} ?>><?php echo $j->tipe_pembayaran; ?></option>
          <?php } ?>
        </select>
      </div>
      <div class="form-group">
